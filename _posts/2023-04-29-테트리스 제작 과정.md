...
테트리스 프레임임 크기의 비율은 12*22로 설정하고.
640*480의 화면출력에서 실제 크기를 정해야된다.
...
해당 위치의 값을 참고해서 사각형의 종류를 선택하고 한번에 그리는게 효율적일거같다.
...
rgba값을 직접 입력하고, 함수 호출 부분에서만 사용하게 코드를 변경했다.
